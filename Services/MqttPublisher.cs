...
internal sealed class MqttPublisher : IDisposable
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>An announcement pass asks forty entities in turn and a publish pass asks them again, and
    /// two of the three sources behind them reach a vendor interface. Without this, one pass is forty
    /// EC or WMI calls.</para>
