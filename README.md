...
connects to your broker and announces a single **ChargeKeeper** device with forty-eight entities — battery
...
settings panel the MQTT page hosts. ChargeKeeper supplies the topic root, the forty-eight entity
