...
connects to your broker and announces a single **ChargeKeeper** device with sixty-five entities — battery
...
a shell script or a flow engine reads one with no parsing. Thirty-three of them take commands, and a
...
ChargeKeeper supplies the topic root, the sixty-five entity
