...
internal static class AboutContent
{
    ...
    internal static AboutInfo Build(Action? showWhatsNew = null) => new()
    {
        ...
        [
            ...
            new ExternalLibrary("NLog", "Jarek Kowalski, Kim Christensen, Julian Verdurmen", "Event log, rolled daily with a size cap (app.log)", "BSD-3-Clause", "https://github.com/NLog/NLog"),
        ],
    };
}
